# genpark-agentic-software-engineer-code-synthesis-skill
...
> **GenPark AI Agent Skill** -- Agentic software engineer for full-stack application synthesis (LaraCopilot style)
